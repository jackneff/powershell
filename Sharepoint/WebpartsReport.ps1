...
$SiteURL = "http://site"
$ReportOutput = "$PSScriptRoot/webparts.csv"
...
#Read more: https://www.sharepointdiary.com/2015/08/find-all-web-parts-in-use-in-sharepoint-using-powershell.html#ixzz7o8tsvExm