  ...
  <Window.Resources>
   ...
   <Grid>
      ...
      <StackPanel Name="TextBoxControls" Grid.Column="2" Grid.ColumnSpan="2" Grid.Row="2" HorizontalAlignment="Right" Margin="0,0,15,0" VerticalAlignment="Top" Orientation="Horizontal">
         <TextBlock Name="Clear" Text="Clear" Width="50" Foreground="Blue" />
         <TextBlock Name="Export" Width="50" Foreground="Blue">
      ...
      <StackPanel Name="Bottom" Grid.Column="0" Grid.ColumnSpan="4" Grid.Row="3">
         <ScrollViewer>
           <TextBox Name="DisplayBox" Width="855" Height="200" HorizontalAlignment="Left" Margin="10,25,0,10" BorderBrush="Gray" BorderThickness="2"
             ScrollViewer.HorizontalScrollBarVisibility="Auto" VerticalScrollBarVisibility="Auto" FontFamily="Courier New" />
         </ScrollViewer>
      </StackPanel>
   </Grid>
</Window>
...
$Link_Clear = $UserInterFace.FindName('Clear')
$Link_Export = $UserInterFace.FindName('Export')
...
$Btn_WhosLoggedOn.Add_Click({
    ...
    $Output1.Text += "=====================[$(Get-Date -Format T)]::[WhosLoggedOn]::[$($Input1.Text)]=====================`n"
    $Output1.Text += $Result.Trim()
    $Output1.AppendText($dl)
    $Output1.ScrollToEnd()
})
...
$Btn_SystemInfo.Add_Click({
    ...
    $Output1.Text += "=====================[$(Get-Date -Format T)]::[SystemInfo]::[$($Input1.Text)]=========================`n"
    $Output1.Text += $Result.Trim()
    $Output1.AppendText($dl)
    $Output1.ScrollToEnd()
})

$Link_Clear.Add_MouseUp({
    $Output1.Clear()
})
